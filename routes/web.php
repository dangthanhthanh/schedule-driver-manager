...
Route::get('drivers/statuses', [DriverController::class, 'getAvailableStatuses'])->name('drivers.statuses');
...
Route::get('trucks/statuses', [TruckController::class, 'getAvailableStatuses'])->name('trucks.statuses');
